                ...
                <div className="flex flex-wrap items-center justify-between gap-[10px] pt-1">
                  <div className="flex flex-wrap items-center gap-[12px]">
                    <label
                      ...
                      title={t('dub.auto_clone_voice_title')}
                    >
                      <input
                        type="checkbox"
                        className="accent-[var(--color-brand)] cursor-pointer"
                        checked={!!autoVoiceClone}
                        disabled={dubStep === 'uploading' || dubStep === 'transcribing'}
                        onChange={(e) => setAutoVoiceClone?.(e.target.checked)}
                      />
                      {t('dub.auto_clone_voice')}
                    </label>
                    <label
            ...
            <>
              ...
              {landingAdvOpen && (
                <div className="flex flex-wrap items-center gap-[12px] mt-[6px] px-[10px] py-[8px] [border:1px_solid_var(--chrome-border)] rounded-[10px]">
                  <label
                    className="dub-landing-adv__field inline-flex items-center gap-[6px] text-[0.7rem] text-[var(--chrome-fg-muted)] cursor-pointer"
                    title={t('dub.auto_clone_voice_title')}
                  >
                    <input
                      type="checkbox"
