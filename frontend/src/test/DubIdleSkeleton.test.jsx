...
describe('IdleSkeleton — pipeline-stage vs idle dropzone', () => {
  ...
  it('keeps both Settings and retry actions beside a missing-ASR/Deepgram error', () => {
    const retry = vi.fn();
    ...
    renderIdle({
      ...
      dubError: 'ASR error: Deepgram API key missing or invalid.',
      handleDubRetryTranscribe: retry,
    });
    fireEvent.click(screen.getByRole('button', { name: 'Settings' }));
    fireEvent.click(screen.getByRole('button', { name: 'Retry transcription' }));
    expect(openSettingsTab).toHaveBeenCalledWith('engines');
