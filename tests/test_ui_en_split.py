...
def test_setupUi_creates_key_widgets():
    ...
    expected_widgets = [
        ...
        'reglabel', 'recogn_type', 'model_name_help', 'model_name', 'btn_ocr_roi',
        ...
        'tts_text', 'tts_type', 'label_4', 'voice_role', 'listen_btn', 'btn_vieneu_voices',
        ...
        'subtitle_layout', 'statusBar', 'menuBar',
...
def test_setupUi_creates_actions():
    ...
    expected_actions = [
        'actionchatgpt_key', 'actiondeepseek_key',
        'action_ffmpeg', 'action_git', 'action_issue',
        'actiondeepgram', 'action_ocr', 'actiontts_refaudio',
        ...
        'action_set_proxy', 'actiongemini_key',
        'actionElevenlabs_key', 'actionwatermark',
