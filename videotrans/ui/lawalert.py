...
<ul>
    ...
    <li><strong>第三方服务</strong>：当您选择使用集成的第三方API服务（如 Google Gemini、ElevenLabs 等）时，相关数据将直接由您的计算机发送至相应的第三方服务提供商。您的数据处理将受限于该第三方服务商的隐私政策和使用条款。开发者不参与此过程，也不对第三方服务的数据安全和隐私泄露承担任何责任。</li>
